...
def print_board(board):
  for row in board:
    for slot in row:        #with this for loop we look in all of the lists in board
      print(f"{slot} ", end="")
    print()
...
while turns < 9:
  ...
  print_board(board)
  user_input = input("Please enter a position 1 through 9 or enter \"quit\" to exit game:")
